 ...
 * @since 1.5.3
 */
public final class KolmogorovSmirnovPlus {

    private static final double EPSILON = 1.0e-12;

    /**
     * Computes the <b>complementary</b> distribution function
     * bar(F)<sup>n</sup>(<em>x</em>) with parameter {@code n}, which is
     * {@code P[D_n^+ >= x]}.
     * <p>
     * The same distribution serves both one-sided statistics: {@code D_n^-}
     * has it too, by symmetry.
     *
     * @param n
