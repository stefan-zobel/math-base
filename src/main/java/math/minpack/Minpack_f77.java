...
// epsmch is the machine precision
    ...
    private static final double epsmch = 2.22044604926e-16;
...
// minmag is the smallest magnitude
    ...
    private static final double p0001 = .0001;
    private static final double p001 = .001;
    private static final double p05 = .05;
    private static final double p1 = .1;
    private static final double p25 = .25;
    private static final double p5 = .5;
    private static final double p75 = .75;
...
// Call lmder_f77.
            ...
            Minpack_f77.lmder_f77(nlls, m, n, x, fvec, fjac, ftol, xtol, gtol, maxfev, diag, mode, factor, nprint, info,
                    nfev, njev, ipvt, qtf);
...
*from the FORTRAN MINPACK source produced by Garbow, Hillstrom, and More.
*<p>
...
*/
    public static void qrfac_f77(int m, int n, double a[][], boolean pivot, int ipvt[], double rdiag[], double acnorm[],
            double wa[]) {
...
// Termination
                ...
                if (iter == 0) // "lgtm[java/constant-comparison]"
                    par[1] = zero;
                return;
...
// The Java compiler complains if delta and xnorm have not been
// initialized.
...
*/
    public static void fdjac2_f77(Lmdif_fcn nlls, int m, int n, double x[], double fvec[], double fjac[][], int iflag[],
