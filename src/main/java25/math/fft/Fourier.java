        ...
        while (lastN0 < n) {
            ...
            for (int destEvenStartIndex = 0; destEvenStartIndex < n; destEvenStartIndex += n0) {
                ...
                for (int r = 0; r < lastN0; r++) {
                    ...
                    // destOddStartIndex + r = hrR * wR - hrI * wI
                    double tr = hrR * wR - hrI * wI;
                    double ti = hrR * wI + hrI * wR;

                    dataR[destEvenStartIndex + r] = grR + tr;
                    dataI[destEvenStartIndex + r] = grI + ti;
                    dataR[destOddStartIndex + r] = grR - tr;
                    dataI[destOddStartIndex + r] = grI - ti;

                    double nextWR = wR * wSubN0R - wI * wSubN0I;
                    double nextWI = wR * wSubN0I + wI * wSubN0R;
                    wR = nextWR;
                    wI = nextWI;
                }
            }
